...
namespace Mario {
    ...
    void PlayerController::Init(Ref<Scene> scene, bool isShort, Color color)
    {
        ...
        s_Texture = s_ActiveScene->AddTextureToScene("../../../Mario/assets/Resources/Graphics/Player.png");
    ...
    void PlayerController::OnUpdate(Timestep ts)
    {
        ...
        
        {
            ...
            m_CameraRefPos       = &s_ActiveScene->GetPrimaryCameraEntity().GetComponent<TransformComponent>().Translation.x;
